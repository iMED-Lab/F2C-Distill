...
def main():
    ...
    # 大改
    tokenizer = AutoTokenizer.from_pretrained("./Bio_ClinicalBERT_tokenizer", local_files_only=True)
    ...
    if args.mrdef_csv_file:
        ...
        scaler = torch.amp.GradScaler(device="cuda") if args.precision == "amp" else None
    ...
    print('num_samples',num_samples,'num_batches',num_batches)
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        train_one_epoch(model, tokenizer, dataloader, num_batches, num_samples,
                        epoch, optimizer, scaler, scheduler, args, writer)
